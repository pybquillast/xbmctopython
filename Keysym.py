'''
            Archivo generado desde: https://github.com/xbmc/xbmc/blob/master/xbmc/input/XBMC_keysym.h
'''
...
XBMCKMOD_CTRL             = (XBMCKMOD_LCTRL  | XBMCKMOD_RCTRL)
XBMCKMOD_SHIFT            = (XBMCKMOD_LSHIFT | XBMCKMOD_RSHIFT)
XBMCKMOD_ALT              = (XBMCKMOD_LALT   | XBMCKMOD_RALT)
XBMCKMOD_META             = (XBMCKMOD_LMETA  | XBMCKMOD_RMETA)
XBMCKMOD_SUPER            = (XBMCKMOD_LSUPER | XBMCKMOD_RSUPER)